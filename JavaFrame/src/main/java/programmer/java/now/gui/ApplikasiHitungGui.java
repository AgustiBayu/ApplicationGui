 ...
 * @author 62813
 */
public class ApplikasiHitungGui extends javax.swing.JFrame {

    /**
     * Creates new form ApplikasiHitungGui
     */
    public ApplikasiHitungGui() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APPLIKASI ARITMATIKA GUI");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setText("INPUTKAN ANGKA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplikasiHitungGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApplikasiHitungGui().setVisible(true);
            }
        });
    }
