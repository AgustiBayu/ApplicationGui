 ...
 * @author 62813
 */
public class DasbordGui extends javax.swing.JFrame {

    /**
     * Creates new form DasbordGui
     */
    public DasbordGui() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DasbordGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DasbordGui().setVisible(true);
            }
        });
    }
